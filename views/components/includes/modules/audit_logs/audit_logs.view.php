...
<div class="card">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <?php if (isset($is_super_admin) && $is_super_admin): ?>
                <form method="post" onsubmit="return confirm('Are you sure you want to completely clear all audit logs? This action cannot be undone.');">
                    <?php echo render_csrf_field(); ?>
                    <input type="hidden" name="clear_audit_logs" value="1">
                    <button type="submit" class="btn btn-danger" style="background-color: var(--danger, #e74c3c); color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer;">🗑️ Clear Logs</button>
                </form>
            <?php endif; ?>
        </div>
