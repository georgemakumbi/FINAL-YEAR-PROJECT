...
// Prepare for notification form (from POST if present, empty otherwise)
$selected_student_ids = isset($_POST['student_ids']) ? $_POST['student_ids'] : [];
$notification_message = isset($_POST['notification_message']) ? trim($_POST['notification_message']) : '';
$show_notification_form = !empty($selected_student_ids) || !empty($notification_message);
