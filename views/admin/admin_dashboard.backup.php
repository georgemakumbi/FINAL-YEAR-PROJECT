...
$recent_votes = $conn->query("SELECT al.timestamp AS vote_date, COALESCE(NULLIF(TRIM(CONCAT(s.first_name, ' ', s.last_name)), ''), al.user_id) AS first_name, '' AS last_name, al.details AS candidate_first_name, '' AS candidate_last_name 
    FROM audit_log al 
